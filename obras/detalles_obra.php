...
<body>
    ...
    <section><br>
    <a href="./inicio_obras.php" class="btn" style="text-decoration:none;"><input type="button" value="Regresar" 
    ...
    cursor: pointer;"></a><br><br><br><br><br>
        ...
        <?php
             ...
             $id = $_GET['id_obra'];
             $re=$mysql->query("select * from obras where id_obra=".$_GET['id_obra'])or die($mysql->error);
    ...
    border-radius: 8px;
    cursor: pointer;">
             <img class="imgen_obras" style="border-radius: 20px;" src="../img_obras/<?php echo $f['imagen'];?>"><br>
             <span><?php echo $f['nombre'];?></span><br>
             <span><h3>Fecha De Inicio:</h3> <?php echo $f['fecha_inicio'];?></span><br>
             <span><h3>Fecha Final: </h3><?php echo $f['fecha_final'];?></span><br>
             <span><h3>Lugar:</h3> <?php echo $f['lugar'];?></span><br>
             <span><h3>Area: </h3><?php echo $f['area'];?></span><br>
             <span><h3>Descripcion:</h3> <?php echo $f['descripcion'];?></span><br>
             
             
             </a>
             <a href="inicio_obras.php"> Ver Obras </a>
              <?php } ?>
              </div>
         </center>
         <?php
